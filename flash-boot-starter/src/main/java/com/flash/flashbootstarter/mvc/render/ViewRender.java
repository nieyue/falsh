...
import com.flash.flashbootstarter.mvc.bean.ModelAndView;
...
public class ViewRender implements Render {
    ...
    public void render(RequestHandlerChain handlerChain) throws Exception {
        ...
        req.getRequestDispatcher(FlashBootStarterApplication.getConfiguration().getViewPath() + path).forward(req, resp);
