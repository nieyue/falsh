...
import com.flash.flashbootstarter.Configuration;
import com.flash.flashbootstarter.FlashBootStarterApplication;
import com.flash.flashbootstarter.mvc.DispatcherServlet;
...
public class TomcatServer implements Server {
    ...
    public TomcatServer() {
        new TomcatServer(FlashBootStarterApplication.getConfiguration());
    }
